...
const VerifyCodeForm: FC<VerifyCodeFormProps> = ({ cellCount, cognitoUser, phone }) => {
  const { value, onChange, errors, isSubmitting } = useVerifyCodeForm(cellCount, cognitoUser, phone);
