...
import FourthStepButton from 'shared/assets/images/onboarding/FourthStepButton.png';
import FourthStepUser1 from 'shared/assets/images/onboarding/FourthStepUser1.png';
import FourthStepUser2 from 'shared/assets/images/onboarding/FourthStepUser2.png';
import { AppText } from 'shared/ui';

import { StepProps } from '../../../types';
import styles from './step.style';

const FourthStep: FC<StepProps> = ({ titleKey, descriptionKey }) => {
    ...
    <View>
      <View style={styles.imageWrapper}>
        <View style={styles.contentContainer}>
          <Animated.Image
            source={FourthStepUser1}
            style={[styles.firstImage, animatedFirstStyles]}
            resizeMode="cover"
          />
          <Animated.Image
            source={FourthStepUser2}
            style={[styles.secondImage, animatedSecondStyles]}
            resizeMode="cover"
          />
        </View>
        <Animated.Image source={FourthStepButton} style={[styles.thirdImage]} resizeMode="cover" />
      </View>
